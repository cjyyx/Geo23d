...
/*
 * Function: MyRaiseException
 * Usage: MyRaiseException(&e, name, value);
 * ---------------------------------------
...
void MyRaiseException(exception *e, string name, void *value);
...
#define raise(e) MyRaiseException(&e, #e, NULL)
